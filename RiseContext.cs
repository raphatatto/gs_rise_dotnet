    ...
    public class RiseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                ...
                // coluna criada como "desc" (com aspas) no Oracle → case-sensitive
            ...
            {
                entity.ToTable("TB_RISE_TRILHA_PROGRESO"); // cuidado: nome exato da tabela
                entity.ToTable("TB_RISE_TRILHA_PROGRESSO");

                entity.HasKey(e => e.IdTrilha)
                      .HasName("PK_TRILHA_PROGRESO")
